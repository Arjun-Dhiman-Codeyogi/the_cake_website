...
const allProducts: Product[] = [
  // Fleur Delice
  { name: "Flowers in Bloom", price: "\u20B96,500", image: "/images/photo-1618160702438-9b02ab6515c9.webp", badge: "Signature", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Enchanted Garden", price: "\u20B96,000", image: "/images/photo-1486427944299-d1955d23e34d.webp", badge: "New", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Rosette Dream", price: "\u20B95,500", image: "/images/photo-1565958011703-44f9829ba187.webp", badge: "Bestseller", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Blush Cascade", price: "\u20B95,800", image: "/images/photo-1571115177098-24ec42ed204d.webp", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Petal Whisper", price: "\u20B95,200", image: "/images/photo-1488477181946-6428a0291777.webp", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Garden Soir\u00E9e", price: "\u20B96,200", image: "/images/photo-1563729784474-d77dbb933a9e.webp", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Cherry Blossom", price: "\u20B94,800", image: "/images/photo-1551024601-bec78aea704b.webp", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Lavender Haze", price: "\u20B95,000", image: "/images/photo-1464349095431-e9a21285b5f3.webp", category: "Fleur Delice", slug: "/fleur-delice" },
  { name: "Florentine Delight", price: "\u20B95,600", image: "/images/photo-1558636508-e0db3814bd1d.webp", category: "Fleur Delice", slug: "/fleur-delice" },

  // Signature Cakes
  { name: "Classic Chocolate Truffle", price: "\u20B91,800", image: "/images/photo-1578985545062-69928b1d9587.webp", badge: "Bestseller", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Red Velvet Royale", price: "\u20B92,200", image: "/images/photo-1606890737304-57a1ca8a5b62.webp", badge: "Signature", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Vanilla Bean Dream", price: "\u20B91,600", image: "/images/photo-1535141192574-5d4897c12636.webp", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Hazelnut Praline", price: "\u20B92,500", image: "/images/photo-1481391319762-47dff72954d9.webp", badge: "New", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Tiramisu Tower", price: "\u20B92,800", image: "/images/photo-1551024601-bec78aea704b.webp", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Caramel Drizzle", price: "\u20B92,000", image: "/images/photo-1464349095431-e9a21285b5f3.webp", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Pistachio Bliss", price: "\u20B92,400", image: "/images/photo-1563729784474-d77dbb933a9e.webp", badge: "Popular", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Mango Passion", price: "\u20B91,900", image: "/images/photo-1565958011703-44f9829ba187.webp", category: "Signature Cakes", slug: "/signature-cakes" },
  { name: "Dark Forest Gateau", price: "\u20B92,100", image: "/images/photo-1588195538326-c5b1e9f80a1b.webp", category: "Signature Cakes", slug: "/signature-cakes" },

  // Signature Tarts & Cheesecakes
  { name: "Classic Lemon Tart", price: "\u20B9950", image: "/images/photo-1519915028121-7d3463d20b13.webp", badge: "Bestseller", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "Blueberry Cheesecake", price: "\u20B91,400", image: "/images/photo-1533134242443-d4fd215305ad.webp", badge: "Signature", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "Raspberry Tart", price: "\u20B91,100", image: "/images/photo-1464305795204-6f5bbfc7fb81.webp", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "New York Cheesecake", price: "\u20B91,600", image: "/images/photo-1524351199678-941a58a3df50.webp", badge: "Popular", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "Chocolate Ganache Tart", price: "\u20B91,200", image: "/images/photo-1606890737304-57a1ca8a5b62.webp", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "Mango Cheesecake", price: "\u20B91,300", image: "/images/photo-1565958011703-44f9829ba187.webp", badge: "New", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "Passion Fruit Tart", price: "\u20B91,050", image: "/images/photo-1486427944299-d1955d23e34d.webp", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "Baked Strawberry Cheesecake", price: "\u20B91,500", image: "/images/photo-1571115177098-24ec42ed204d.webp", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },
  { name: "Salted Caramel Tart", price: "\u20B91,150", image: "/images/photo-1481391319762-47dff72954d9.webp", badge: "Chef's Pick", category: "Tarts & Cheesecakes", slug: "/signature-tarts" },

  // Pizzas & Burgers
  { name: "Margherita Pizza", price: "\u20B9450", image: "/images/photo-1574071318508-1cdbab80d002.webp", badge: "Bestseller", category: "Pizzas & Burgers", slug: "/signature-savoury" },
  { name: "Farm Fresh Veggie Pizza", price: "\u20B9550", image: "/images/photo-1565299624946-b28f40a0ae38.webp", badge: "Popular", category: "Pizzas & Burgers", slug: "/signature-savoury" },
  { name: "Classic Veg Burger", price: "\u20B9350", image: "/images/photo-1568901346375-23c9450c58cd.webp", badge: "Bestseller", category: "Pizzas & Burgers", slug: "/signature-savoury" },
  { name: "Spicy Paneer Burger", price: "\u20B9420", image: "/images/photo-1550547660-d9450f859349.webp", category: "Pizzas & Burgers", slug: "/signature-savoury" },

  // TPR Bespoke
  { name: "Signature Chocolate Cake", price: "From \u20B91,500", image: "/images/photo-1606890737304-57a1ca8a5b62.webp", badge: "Bestseller", category: "TPR Bespoke", slug: "/tpr-bespoke" },
  { name: "Victorian Vanilla", price: "From \u20B91,800", image: "/images/photo-1535141192574-5d4897c12636.webp", category: "TPR Bespoke", slug: "/tpr-bespoke" },
  { name: "Fondant Fantasy", price: "From \u20B93,500", image: "/images/photo-1551024601-bec78aea704b.webp", badge: "Custom", category: "TPR Bespoke", slug: "/tpr-bespoke" },
  { name: "Tiered Elegance", price: "From \u20B98,000", image: "/images/photo-1464349095431-e9a21285b5f3.webp", category: "TPR Bespoke", slug: "/tpr-bespoke" },

  // Gourmet
  { name: "Dark Chocolate Truffles", price: "\u20B9850", image: "/images/photo-1548907040-4baa42d10919.webp", badge: "New", category: "Gourmet", slug: "/gourmet" },
  { name: "Rose Macarons (Box of 6)", price: "\u20B9750", image: "/images/photo-1558326567-98ae2405596b.webp", badge: "Bestseller", category: "Gourmet", slug: "/gourmet" },
  { name: "Luxury Gift Hamper", price: "\u20B92,500", image: "/images/photo-1549465220-1a8b9238cd48.webp", category: "Gourmet", slug: "/gourmet" },
  { name: "Pistachio \u00C9clair", price: "\u20B9380", image: "/images/photo-1530610476181-d83430b64dcd.webp", category: "Gourmet", slug: "/gourmet" },
];

...
const instaImages = [
  ...
  "https://images.unsplash.com/photo-1549312801-e9f58dbdcba4?w=400&q=80",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <p className="font-lato text-xs tracking-[0.35em] uppercase text-blush mb-4 animate-fade-in-up">
            Mumbai's Luxury Patisserie
          </p>
          <h1 className="font-playfair text-5xl md:text-7xl text-primary-foreground mb-3 animate-fade-in-up">
            {heroSlides[current].headline}
          </h1>
          <h2 className="font-playfair italic text-3xl md:text-5xl text-blush mb-8 animate-fade-in-up">
            {heroSlides[current].sub}
          </h2>
          <Link
            to="/fleur-delice"
            className="btn-sweep inline-block border border-primary-foreground text-primary-foreground font-lato text-xs tracking-widest uppercase px-10 py-3.5 rounded-full hover:bg-primary-foreground hover:text-burgundy transition-colors duration-300 animate-fade-in-up"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {signatures.map((p, i) => (
            <ScrollReveal key={p.name} delay={i * 100}>
              <ProductCard {...p} slug="/fleur-delice" />
            </ScrollReveal>
          ))}
        </div>
      ...
      <section className="grid md:grid-cols-2 h-[480px] overflow-hidden">
        <ScrollReveal className="relative overflow-hidden group cursor-pointer">
          <Link to="/fleur-delice" className="block h-full">
            ...
            <div className="absolute inset-0 bg-mauve/50 group-hover:bg-mauve/60 transition-colors duration-500 flex flex-col items-center justify-center text-center p-8">
              ...
              <h3 className="font-playfair text-4xl text-primary-foreground mb-4">
                Fleur Delice
              </h3>
      ...
      <section className="py-24 px-6 bg-secondary">
        <ScrollReveal className="max-w-3xl mx-auto text-center">
          <div className="animate-petal text-5xl mb-6">🌸</div>
          <blockquote className="font-playfair italic text-3xl md:text-4xl text-foreground leading-relaxed mb-6">

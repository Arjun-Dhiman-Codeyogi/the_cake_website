  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-52 md:h-72 overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=1600&q=85"
          alt="Get In Touch"
        ...
        <div className="absolute inset-0 bg-burgundy/65 flex flex-col items-center justify-center text-center">
          ...
          <h1 className="font-playfair text-5xl text-primary-foreground animate-fade-in-up">
            Get In Touch
          </h1>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16">
        ...
        <ScrollReveal className="animate-slide-left">
          <div className="text-5xl mb-6 animate-petal">🌸</div>
